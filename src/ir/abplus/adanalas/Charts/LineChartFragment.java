...
public class LineChartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        p.setSelectedColor(resources.getColor(R.color.darker_blue));
        l.addPoint(p);
        p = new LinePoint();
        p.setX(8);
        p.setY(8);
        ...
        l.setColor(resources.getColor(R.color.black));

        Line l2 = new Line();
        l2.setUsingDips(true);
        ...
        p2.setY(2);
         l2.addPoint(p2);
        l2.setColor(resources.getColor(R.color.green));
