    ...
    public void onDraw(Canvas canvas) {
        ...
        for (final Bar bar : mBars) {
            ...
            if (mShowAxisLabel) {
                ...
                mPaint.setTypeface(persianTypeface);
                if (isAnimating()) mPaint.setAlpha(alpha);
                float textWidth = mPaint.measureText(bar.getName());
...
//        Log.i("e","animation start");
    ...
    public static void setPersianTypeface(Typeface persianTypeface) {
        BarGraph.persianTypeface = persianTypeface;
    }
}
