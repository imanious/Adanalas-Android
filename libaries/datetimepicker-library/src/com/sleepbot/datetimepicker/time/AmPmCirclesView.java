...
//        this.mPersianPMText = persianPMText;
    ...
    public void initialize(Context context, int amOrPm, String mPersianAMText, String mPersianPMText, int mMode) {
        if (mIsInitialized) {
...
//        setPersianAMText(mPersianAMText);
//        setPersianPMText(mPersianPMText);
	...
	{
		if(mMode != PersianTimePickerDialog.PERSIAN && mMode != PersianTimePickerDialog.ENGLISH)
