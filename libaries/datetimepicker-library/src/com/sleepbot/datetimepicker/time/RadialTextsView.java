...
public class RadialTextsView extends View {
    ...
    public void initialize(Resources res, String[] texts, String[] innerTexts,
                           boolean is24HourMode, boolean disappearsOut, Typeface mTypeface) {
        if (mIsInitialized) {
        ...
        if(!mTypeface.equals(Typeface.create(Typeface.DEFAULT, Typeface.NORMAL)))
        {
        	mTypefaceLight = mTypeface;
        	mTypefaceRegular = mTypeface;
        }
