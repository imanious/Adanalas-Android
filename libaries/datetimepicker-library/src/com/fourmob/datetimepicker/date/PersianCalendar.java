...
public class PersianCalendar extends Calendar {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5411240638662009835L;
    ...
    public static String[] weekdayShortNames = {"", "یک", "دو", "سه", "چهار", "پنج", "جمعه", "شنبه"};
	public static String[] weekdayFullNames = {"", "یک‌شنبه", "دوشنبه", "سه‌شنبه", "چهارشنبه", "پنج‌شنبه", "جمعه", "شنبه"};
	public static String[] months = {	"فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", 
    ...
    public PersianCalendar(int year, int month, int dayOfMonth, int hourOfDay,
                           int minute) {
    ...
    PersianCalendar(int year, int month, int dayOfMonth,
    ...
    public static void main(String[] args)
    {
		...
		PersianCalendar cal2 = new PersianCalendar(1379, 11, 30);
		System.out.println(cal2.get(PersianCalendar.YEAR));
		System.out.println(cal2.get(PersianCalendar.MONTH));
		System.out.println(cal2.get(PersianCalendar.DAY_OF_MONTH));
		System.out.println(cal2.get(PersianCalendar.DAY_OF_WEEK));
	}

	public String getMonthYearString()
	{
		String yearString = Utils.toPersianNumbers(this.get(YEAR)+"");
		String monthString = "";
		monthString = months[this.get(MONTH)];
		return monthString + " " + yearString;
	}
	
	public boolean equalDay(PersianCalendar c)
	{
		return get(YEAR)==c.get(YEAR) && get(MONTH)==c.get(MONTH) && get(DATE)==c.get(DATE); 
	}
	
	public boolean equalWeek(PersianCalendar c)
	{
		return get(YEAR)==c.get(YEAR) && get(WEEK_OF_YEAR)==c.get(WEEK_OF_YEAR); 
	}
	
	public boolean equalMonth(PersianCalendar c)
	{
		return get(YEAR)==c.get(YEAR) && get(MONTH)==c.get(MONTH); 
	}
	
	public boolean equalYear(PersianCalendar c)
	{
		return get(YEAR)==c.get(YEAR); 
	}
}
