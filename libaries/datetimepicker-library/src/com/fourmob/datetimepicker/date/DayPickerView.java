...
public class DayPickerView extends ListView implements AbsListView.OnScrollListener, PersianDatePickerDialog.OnDateChangedListener {
...
//	private boolean firstTime = true;
	...
	public DayPickerView(Context context, DatePickerController datePickerController, int mMode, Typeface mTypeface) {
		super(context);
		this.mMode = mMode;
