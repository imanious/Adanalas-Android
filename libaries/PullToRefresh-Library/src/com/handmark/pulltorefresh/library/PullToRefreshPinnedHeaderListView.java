...
public class PullToRefreshPinnedHeaderListView extends PullToRefreshAdapterViewBase<PinnedHeaderListView> {
	...
	protected void onReset() {
		 ...
		 */
		Log.e("listview", "onReset");
		if (!mListViewExtrasEnabled) {
			Log.e("listview", "super");
			super.onReset();
			return;
		}
